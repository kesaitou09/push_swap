...
/*   Updated: 2025/11/07 10:57:16 by kesaitou         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
int			parse_arg(t_ring *ring_a, char *av);
...
int			init_ring(t_ring *ring_a, char *av, size_t size);
...
int			sort_process(t_ring *a, t_ring *b);
